...
function argo_scripts() {
	global $wp_styles;
	wp_enqueue_style( 'argo-main-style', get_template_directory_uri().'/assets/css/style-orange.css' ,array(),'5.0');
	wp_enqueue_style( 'argo-style', get_stylesheet_uri());
	wp_enqueue_style( 'argo-responsive', get_template_directory_uri().'/assets/css/responsive.css' ,array(),'5.0' );
